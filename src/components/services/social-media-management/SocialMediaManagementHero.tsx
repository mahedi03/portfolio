...
export function SocialMediaManagementHero() {
  return (
      ...
      <Container className="relative z-10">
        <Reveal>
          <div className="inline-flex items-center gap-2 rounded-full border border-border/80 bg-card/80 px-4 py-1.5 text-xs font-medium backdrop-blur-md">
            ...
            <span className="text-muted-foreground">Platform-Specific Social Media Management</span>
          </div>
          <h1 className="mt-6 max-w-4xl text-[length:var(--text-h1)] font-display font-bold tracking-tight text-foreground">
            Social Media Management Built for Authentic Engagement & Growth
          </h1>
          <p className="mt-3 text-lg font-medium text-primary">
            Strategic Facebook, Instagram, LinkedIn & Pinterest Management for Growing Brands
          </p>
