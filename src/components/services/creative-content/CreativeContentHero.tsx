...
export function CreativeContentHero() {
  return (
      ...
      <Container className="relative z-10">
        <Reveal>
          <div className="inline-flex items-center gap-2 rounded-full border border-border/80 bg-card/80 px-4 py-1.5 text-xs font-medium backdrop-blur-md">
            ...
            <span className="text-muted-foreground">Creative Content Strategy & Copywriting Services</span>
          </div>
          <h1 className="mt-6 max-w-4xl text-[length:var(--text-h1)] font-display font-bold tracking-tight text-foreground">
            Conversion-Focused Creative Content & Brand Copywriting
          </h1>
          <p className="mt-3 text-lg font-medium text-primary">
            Topical Articles, Sales Copy, High-Retention Video Scripts & Brand Narratives
          </p>
          <div className="mt-6 max-w-3xl rounded-xl border border-border/70 bg-card/50 p-6 backdrop-blur-sm">
            <p className="text-base leading-relaxed text-muted-foreground">
              High-performing content bridges customer skepticism and commercial action. Mahedi Hasan produces conversion-focused brand copy, technical editorial assets, and retention-driven social scripts designed to build organic authority and accelerate revenue across digital channels.
            </p>
          </div>
