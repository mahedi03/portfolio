...
export function PinterestAdsHero() {
  return (
      ...
      <Container className="relative z-10">
        <Reveal>
          <div className="inline-flex items-center gap-2 rounded-full border border-border/80 bg-card/80 px-4 py-1.5 text-xs font-medium backdrop-blur-md">
            ...
            <span className="text-muted-foreground">Pinterest Ads Management for Ecommerce & DTC Brands</span>
          </div>
          <h1 className="mt-6 max-w-4xl text-[length:var(--text-h1)] font-display font-bold tracking-tight text-foreground">
            Pinterest Ads Management: High-Intent Visual Search Acquisition
          </h1>
          <p className="mt-3 text-lg font-medium text-primary">
            Shopping Pins, Idea Pins, Visual Search Targeting & High-LTV Customer Acquisition
          </p>
          <div className="mt-6 max-w-3xl rounded-xl border border-border/70 bg-card/50 p-6 backdrop-blur-sm">
            <p className="text-base leading-relaxed text-muted-foreground">
              Pinterest is not a social network; it is a visual search and discovery engine where over 480 million active users plan future purchases. Mahedi Hasan builds targeted Pinterest Ads campaigns that drive high-value ecommerce sales and long-tail brand discovery.
            </p>
          </div>
