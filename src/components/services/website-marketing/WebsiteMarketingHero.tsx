...
export function WebsiteMarketingHero() {
  return (
      ...
      <Container className="relative z-10">
        <Reveal>
          <div className="inline-flex items-center gap-2 rounded-full border border-border/80 bg-card/80 px-4 py-1.5 text-xs font-medium backdrop-blur-md">
            ...
            <span className="text-muted-foreground">Full-Funnel Website Marketing Services</span>
          </div>
          <h1 className="mt-6 max-w-4xl text-[length:var(--text-h1)] font-display font-bold tracking-tight text-foreground">
            Website Marketing Services in Bangladesh & Global Markets
          </h1>
          <p className="mt-3 text-lg font-medium text-primary">
            SEO, Answer Engine Optimization (AEO), Generative Engine Optimization (GEO) & CRO
          </p>
          <div className="mt-6 max-w-3xl rounded-xl border border-border/70 bg-card/50 p-6 backdrop-blur-sm">
            <p className="text-base leading-relaxed text-muted-foreground">
              Building a website is only the first step—without a structured acquisition and conversion system, your site remains an invisible digital brochure. Mahedi Hasan builds comprehensive website marketing systems combining Technical SEO, AEO, GEO, and CRO to drive qualified traffic and scalable revenue.
            </p>
          </div>
