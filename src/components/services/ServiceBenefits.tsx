...
export function ServiceBenefits({ service }: { service: Service }) {
  return (
    <section className="border-t border-border bg-surface py-20">
      <Container>
        <Reveal className="mx-auto max-w-2xl text-center"><h2 className="text-[length:var(--text-h2)] font-display font-bold tracking-tight">Why {service.shortTitle} matters</h2></Reveal>
