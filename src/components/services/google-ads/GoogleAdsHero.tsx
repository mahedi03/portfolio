      ...
      <Container className="relative z-10">
        <Reveal>
          <div className="inline-flex items-center gap-2 rounded-full border border-border/80 bg-card/80 px-4 py-1.5 text-xs font-medium backdrop-blur-md">
            ...
            <span className="text-muted-foreground">Google Ads Management & PPC Optimization</span>
          </div>
          <h1 className="mt-6 max-w-4xl text-[length:var(--text-h1)] font-display font-bold tracking-tight text-foreground">
            Intent-Driven Google Ads Management & Performance PPC
          </h1>
          <p className="mt-3 text-lg font-medium text-primary">
            High-Intent Search Campaigns, Performance Max, YouTube Funnels & GA4 Attribution
          </p>
          <div className="mt-6 max-w-3xl rounded-xl border border-border/70 bg-card/50 p-6 backdrop-blur-sm">
            <p className="text-base leading-relaxed text-muted-foreground">
              Google Ads captures customers at the exact instant they search for a commercial solution. Mahedi Hasan builds high-intent Search campaigns, automated Performance Max architectures, and YouTube video funnels engineered for maximum return on ad spend and verified lead generation.
            </p>
          </div>
