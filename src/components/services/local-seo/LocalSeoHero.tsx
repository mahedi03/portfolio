      ...
      <Container className="relative z-10">
        <Reveal>
          <div className="inline-flex items-center gap-2 rounded-full border border-border/80 bg-card/80 px-4 py-1.5 text-xs font-medium backdrop-blur-md">
            ...
            <span className="text-muted-foreground">Local SEO & Google Business Profile Optimization</span>
          </div>
          <h1 className="mt-6 max-w-4xl text-[length:var(--text-h1)] font-display font-bold tracking-tight text-foreground">
            Local SEO Services & Google Map Pack Domination
          </h1>
          <p className="mt-3 text-lg font-medium text-primary">
            Google Business Profile, Localized Schema, Citation Networks & High-Trust Reviews
          </p>
          <div className="mt-6 max-w-3xl rounded-xl border border-border/70 bg-card/50 p-6 backdrop-blur-sm">
            <p className="text-base leading-relaxed text-muted-foreground">
              Local SEO ensures your business captures customers searching for services in specific cities, districts, and neighborhoods. Mahedi Hasan optimizes Google Business Profiles, localized schema data, and geographic authority networks to dominate high-converting local map pack rankings.
            </p>
          </div>
