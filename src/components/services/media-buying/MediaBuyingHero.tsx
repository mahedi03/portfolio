...
export function MediaBuyingHero() {
  return (
      ...
      <Container className="relative z-10">
        <Reveal>
          <div className="inline-flex items-center gap-2 rounded-full border border-border/80 bg-card/80 px-4 py-1.5 text-xs font-medium backdrop-blur-md">
            ...
            <span className="text-muted-foreground">Cross-Platform Media Buying & Paid Advertising</span>
          </div>
          <h1 className="mt-6 max-w-4xl text-[length:var(--text-h1)] font-display font-bold tracking-tight text-foreground">
            Full-Funnel Media Buying & Paid Performance Advertising
          </h1>
          <p className="mt-3 text-lg font-medium text-primary">
            Meta, Google, TikTok, LinkedIn & Pinterest Strategic Budget Allocation
          </p>
          <div className="mt-6 max-w-3xl rounded-xl border border-border/70 bg-card/50 p-6 backdrop-blur-sm">
            <p className="text-base leading-relaxed text-muted-foreground">
              Media buying is the discipline of allocating advertising capital across multiple channels to maximize blended customer acquisition efficiency. Mahedi Hasan plans, executes, and scales multi-channel paid ad campaigns that turn advertising spend into predictable profit.
            </p>
          </div>
